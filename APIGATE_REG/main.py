...
###            CREAR TOKEN           ###
app.config["JWT_SECRET_KEY"] = 'super-secret' #Se puede colocar cualquiera
jwt = JWTManager(app)
...
def create_token():
    ...
    if response.status_code == 200:
        user = response.json()
        expires = datetime.timedelta(seconds=60*60*24) #Duración un dia
...
# Consultar los resultados de una mesa en particular
...
# Consultar los votos de un candidato en todas las mesas
